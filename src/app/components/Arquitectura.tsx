  ...
  `;
    ...
    return (
        <div className="space-y-6">
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full bg-white border border-gray-300 rounded-lg">
                        ...
                        <tr>
                            ...
                            <td className="py-2 px-4 border-b">aaron.ns.cloudflare.com. dns.cloudflare.com. 2048670054
                        ...
                        <tr>
                            ...
                            <td className="py-2 px-4 border-b">andreavet.cl</td>
                            <td className="py-2 px-4 border-b">185.199.111.153<br/>185.199.110.153<br/>185.199.109.153<br/>185.199.108.153
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="py-2 px-4 border-b">andreavet.cl</td>
                            <td className="py-2 px-4 border-b">2606:50c0:8003::153<br/>2606:50c0:8002::153<br/>2606:50c0:8001::153<br/>2606:50c0:8000::153
                            </td>
                            <td className="py-2 px-4 border-b">1</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className="py-2 px-4 border-b">&quot;v=DMARC1; p=none;
                                rua=mailto:billy@andreavet.cl&quot;</td>
                            <td className="py-2 px-4 border-b">1</td>
                        </tr>
                        <tr>
                            <td className="py-2 px-4 border-b">TXT</td>
            ...
            <section className="bg-white shadow rounded-lg p-6">
                <h3 className="text-xl font-semibold mb-2 text-gray-700">Diferencias entre Servidores de Correo y
                    Streaming</h3>
            ...
            <section className="bg-white shadow rounded-lg p-6">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold mb-2 text-gray-700">DMARC (Domain-based Message
                            Authentication, Reporting, and Conformance)</h3>
                        <p className="text-gray-600">
